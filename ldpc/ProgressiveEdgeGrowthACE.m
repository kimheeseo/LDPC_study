function H = ProgressiveEdgeGrowthACE(N, M, DoYouWantACE)%Random PEG. If you want add ACE improvement, just set 'DoYouWantACE = 1'.
Dv=5;
...
for v = 1 : N
    ...
    for k = 1 : Dv%for each k, we add an '1' in H.
